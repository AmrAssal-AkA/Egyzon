...
function CheckoutPage() {
    _s();
    const { cartItems } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const subPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CheckoutPage.useMemo[subPrice]": ()=>{
            return cartItems.reduce({
                "CheckoutPage.useMemo[subPrice]": (total, item)=>total + Number(item.price) * item.quantity
            }["CheckoutPage.useMemo[subPrice]"], 0);
        }
    }["CheckoutPage.useMemo[subPrice]"], [
        cartItems
    ]);
    const taxPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CheckoutPage.useMemo[taxPrice]": ()=>subPrice * 0.14
    }["CheckoutPage.useMemo[taxPrice]"], [
        subPrice
    ]);
    ...
    const totalPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CheckoutPage.useMemo[totalPrice]": ()=>subPrice + taxPrice + shippingPrice
    }["CheckoutPage.useMemo[totalPrice]"], [
        subPrice,
        taxPrice,
        shippingPrice
    ]);
...
_s(CheckoutPage, "Eu0spmcMIj27MWI1PH5zGAUCrPs=", false, function() {
    return [
...
//# sourceMappingURL=_c03ceadd._.js.map