...
"[project]/components/product/ProductGrid.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/filters/filterSlidbar.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$Products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categories"].map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: cat.slug,
                                    children: cat.name
                                }, cat.id, false, {
                                    fileName: "[project]/components/filters/filterSlidbar.jsx",
...
"[project]/Hooks/useFilter.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useFilter = (products)=>{
    ...
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useFilter.useMemo[filteredProducts]": ()=>{
            let filtered = [
                ...products
            ];
            // Filter by category
            if (filters.category !== "all") {
                filtered = filtered.filter({
                    "useFilter.useMemo[filteredProducts]": (product)=>product.category === filters.category
                }["useFilter.useMemo[filteredProducts]"]);
            }
            // Filter by price range
            if (filters.minPrice !== "") {
                filtered = filtered.filter({
                    "useFilter.useMemo[filteredProducts]": (product)=>product.price >= Number(filters.minPrice)
                }["useFilter.useMemo[filteredProducts]"]);
            }
            if (filters.maxPrice !== "") {
                filtered = filtered.filter({
                    "useFilter.useMemo[filteredProducts]": (product)=>product.price <= Number(filters.maxPrice)
                }["useFilter.useMemo[filteredProducts]"]);
            }
            // Filter by rating
            if (filters.rating > 0) {
                filtered = filtered.filter({
                    "useFilter.useMemo[filteredProducts]": (product)=>product.rating >= filters.rating
                }["useFilter.useMemo[filteredProducts]"]);
            }
            // Filter by seller
            if (filters.seller !== "all") {
                filtered = filtered.filter({
                    "useFilter.useMemo[filteredProducts]": (product)=>product.seller === filters.seller
                }["useFilter.useMemo[filteredProducts]"]);
            }
            // Filter by availability
            if (filters.inStock) {
                filtered = filtered.filter({
                    "useFilter.useMemo[filteredProducts]": (product)=>product.stock > 0
                }["useFilter.useMemo[filteredProducts]"]);
            }
            // Apply sorting
            switch(sortOption){
                case "price-asc":
                    filtered.sort({
                        "useFilter.useMemo[filteredProducts]": (a, b)=>a.price - b.price
                    }["useFilter.useMemo[filteredProducts]"]);
                    break;
                case "price-desc":
                    filtered.sort({
                        "useFilter.useMemo[filteredProducts]": (a, b)=>b.price - a.price
                    }["useFilter.useMemo[filteredProducts]"]);
                    break;
                case "rating":
                    filtered.sort({
                        "useFilter.useMemo[filteredProducts]": (a, b)=>b.rating - a.rating
                    }["useFilter.useMemo[filteredProducts]"]);
                    break;
                case "newest":
                    filtered.sort({
                        "useFilter.useMemo[filteredProducts]": (a, b)=>new Date(b.createdAt) - new Date(a.createdAt)
                    }["useFilter.useMemo[filteredProducts]"]);
                    break;
                case "best-selling":
                    filtered.sort({
                        "useFilter.useMemo[filteredProducts]": (a, b)=>b.sales - a.sales
                    }["useFilter.useMemo[filteredProducts]"]);
                    break;
                default:
                    break;
...
_s(useFilter, "csYEXLWa8fzLAFHSDeZDdrmqrgg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/product/ProductPageClient.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$product$2f$ProductGrid$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/product/ProductGrid.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$Products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/Products.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$filters$2f$filterSlidbar$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/filters/filterSlidbar.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Hooks$2f$useFilter$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Hooks/useFilter.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ProductPageClient() {
    _s();
    const { filteredProducts, filters, setFilter, clearFilters, sortOption, setSortOption } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Hooks$2f$useFilter$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilter"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$Products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductsData"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$filters$2f$filterSlidbar$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    filters: filters,
                    setFilter: setFilter,
                    clearFilters: clearFilters,
                    sortOption: sortOption,
                    setSortOption: setSortOption,
                    products: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$Products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductsData"]
                }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$product$2f$ProductGrid$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ProductPageClient, "1c3es4U1tMWmz6xtjpDSladdp1c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Hooks$2f$useFilter$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilter"]
    ];
});
_c = ProductPageClient;
var _c;
__turbopack_context__.k.register(_c, "ProductPageClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_7b69d40b._.js.map