...
const verifyEmailTemplate = async (to, token, verificationUrl) => {
    return await (0, sendEmail_1.default)(to, "Verify your email", `<div style="font-family: Arial, sans-serif; font-size: 16px; color: #333; text-align: center; padding: 20px;">
        ...
        <Button style="background-color:black; color: blue; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 4px;" href="${verificationUrl}">Verify Email</Button>
