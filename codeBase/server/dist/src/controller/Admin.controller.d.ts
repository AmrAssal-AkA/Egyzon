...
export declare const AdminController: {
    ...
    getAllSellerActiveCounts: (req: Request, res: Response) => Promise<void>;
    getAllSellerPendingCounts: (req: Request, res: Response) => Promise<void>;
    getSellerProductsCategory: (req: Request, res: Response) => Promise<void>;
};
