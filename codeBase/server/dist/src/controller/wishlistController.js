...
const addToWishlist = async (req, res) => {
    try {
        ...
        const response = await wishlist_services_1.WishlistServices.addToWishlist(user, product);
...
const removeFromWishlist = async (req, res) => {
    try {
        ...
        const response = await wishlist_services_1.WishlistServices.removeFromWishlist(user, product);
