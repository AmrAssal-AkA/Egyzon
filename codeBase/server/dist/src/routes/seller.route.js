...
router.post("/apply", Auth_middleware_1.isAuthenticated, rateLimiter_1.uploadLimiter, upload_middleware_1.upload.fields([{ name: 'commercialRegisterImage', maxCount: 1 }, { name: 'taxCardImage', maxCount: 1 }]), (0, validate_1.validate)(seller_validate_1.sellerBaseSchema), StoreCreation_controller_1.default.createRequestToJoin);
router.post("/setup", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Seller), (0, validate_1.validate)(seller_validate_1.sellerSetupStoreSchema), rateLimiter_1.uploadLimiter, upload_middleware_1.upload.fields([{ name: 'storeLogo', maxCount: 1 }, { name: 'storeBanner', maxCount: 1 }]), StoreCreation_controller_1.default.setupStore);
...
router.patch("/change-order-status", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Seller), seller_controller_1.SellerController.changeOrderStatus);
router.get("/balance", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Seller), wallet_controller_1.getWalletBalance);
router.get("/avg-order-value", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Seller), seller_controller_1.SellerController.getAvgOrderValue);
router.get("/sales-performance-indicator", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Seller), seller_controller_1.SellerController.salesPerformanceIndicator);
router.get("/get-salses-by-category", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Seller), seller_controller_1.SellerController.getSalesByCategory);
