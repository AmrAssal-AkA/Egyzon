...
router.post("/setPlatformFee", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Admin), Admin_controller_1.AdminController.setPlatformFee);
router.get("/getPlatformFee", Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Admin), Admin_controller_1.AdminController.getPlatformFee);
