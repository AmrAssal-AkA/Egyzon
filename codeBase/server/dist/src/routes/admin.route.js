...
router.get('/getAllSellerActiveCounts', Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Admin), Admin_controller_1.AdminController.getAllSellerActiveCounts);
router.get('/getAllSellerPendingCounts', Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Admin), Admin_controller_1.AdminController.getAllSellerPendingCounts);
router.get('/getSellerProductsCategory', Auth_middleware_1.isAuthenticated, (0, Authorization_1.Authorize)(auth_types_1.userRole.Admin), Admin_controller_1.AdminController.getSellerProductsCategory);
