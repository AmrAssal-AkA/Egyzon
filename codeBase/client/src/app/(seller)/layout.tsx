...
export default function SellerLayout({ children }: { children: React.ReactNode }) {
  return (
    <PrivateRoute allowedRoles={[Roles.SELLER]}>
      ...
      <div className="min-h-screen flex flex-col md:flex-row gap-4 md:gap-6 p-3.5 sm:p-5 lg:p-6 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        <SellerSideMenue />
