    ...
    <main className="min-h-screen bg-linear-to-br from-slate-50 via-slate-100 to-slate-200 px-4 py-10 sm:px-6 lg:px-8 mt-10 dark:from-background dark:via-secondary dark:to-background">
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl items-center justify-center">
        <div className="grid w-full gap-4 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
          <section className="flex flex-col justify-center rounded-4xl border border-white/60 bg-slate-950 px-8 py4 text-white shadow-2xl shadow-slate-950/10 sm:px-10 sm:py-12 dark:border-border">
