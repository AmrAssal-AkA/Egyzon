  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative bg-secondary shadow-md text-secondary-foreground rounded-md px-3.5 sm:px-4 py-2 min-h-10 cursor-pointer hover:bg-blue-600 hover:text-white transition-colors duration-300 ease-in-out group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 flex items-center justify-center"
        aria-label={`Wishlist, ${displayCount} items`}
        title={`Wishlist (${displayCount})`}
      >
        <FiHeart className="w-4.5 h-4.5 transition-transform duration-300 group-hover:scale-110" aria-hidden="true" />
