      ...
      <div className="lg:col-span-5 space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Have questions about buying, selling, or order support? Our team is available 6 days a week to assist you.
          </p>
        </div>
          ...
          <Card className="border border-border/70 hover:border-primary/40 transition-all shadow-sm">
            <CardContent className="flex items-start gap-4 p-5">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">support@egyzon.com</p>
                <p className="text-xs text-muted-foreground">vendors@egyzon.com</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border/70 hover:border-primary/40 transition-all shadow-sm">
            <CardContent className="flex items-start gap-4 p-5">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">+20 100 000 9988</p>
                <p className="text-xs text-muted-foreground">Sat – Thu: 9:00 AM – 7:00 PM (EGY)</p>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="lg:col-span-7">
        <Card className="border border-border shadow-md">
          <CardHeader className="border-b bg-muted/20">
            ...
            <CardTitle className="text-2xl font-bold">We&apos;re Here to Help</CardTitle>
            <CardDescription className="text-xs">
              Fill out the form below and our customer support or vendor partnership team will get back to you promptly.
            </CardDescription>
          </CardHeader>
            ...
            {submitted ? (
              <div className="py-12 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground max-w-md">
                  Thank you for reaching out to Egyzon. Our support representative will contact you via email shortly.
                </p>
                <Button
                  onClick={() => {
                    setSubmitted(false);
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-lg bg-background border border-input text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <option value="general">Customer Support & Orders</option>
                    <option value="vendor">Become a Vendor / Seller Inquiry</option>
