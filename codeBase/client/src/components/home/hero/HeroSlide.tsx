  ...
  return (
    <div
      ...
      style={{
        background:
          slide.bgGradient ||
          "linear-gradient(135deg, #7A7E85 0%, #A8ABB0 50%, #E3E5E8 100%)",
      }}
    >
      ...
      <div className="md:col-span-7 flex flex-col items-start justify-center text-left order-2 md:order-1 h-full">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link
            ...
            aria-label={`${slide.primaryCtaText}: ${slide.headline} ${slide.headlineItalic || ""}`.trim()}
          ...
          {slide.secondaryCtaText && slide.secondaryCtaLink && (
            <Link
              ...
              tabIndex={isActive ? 0 : -1}
              aria-label={`${slide.secondaryCtaText}: ${slide.headline} ${slide.headlineItalic || ""}`.trim()}
      ...
      <div className="md:col-span-5 flex items-center justify-center order-1 md:order-2 h-48 sm:h-64 md:h-full relative w-full">
        <div className="relative w-full h-full max-h-55 sm:max-h-70 md:max-h-100 aspect-4/3 md:aspect-square rounded-2xl overflow-hidden shadow-2xl border border-white/15">
          <Image
            src={slide.imageUrl}
