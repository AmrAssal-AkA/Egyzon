...
import { ConfirmationBannerProps } from "./CheckoutConfirmation";
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 mt-2 text-sm">
        <div className="flex flex-col items-center bg-background px-4 py-2.5 border border-border rounded-xl shadow-2xs min-w-35">
          <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Order Number</span>
          <span className="font-semibold text-foreground font-mono mt-0.5">{orderNumber}</span>
        </div>

        <div className="flex flex-col items-center bg-background px-4 py-2.5 border border-border rounded-xl shadow-2xs min-w-35">
          <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Order Date</span>
          <span className="font-semibold text-foreground mt-0.5">{orderDate}</span>
        </div>
