...
function RegisterFormPage() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen py-2 mt-15">
        <div className="w-full max-w-4xl px-4 rounded-lg bg-white dark:bg-gray-800">
