              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 dark:bg-gray-700 dark:border-gray-600">
                ...
                >
                  <div className="flex justify-between items-center mb-4 dark:text-gray-300">
                    <CreditCard
                      className={`w-6 h-6 ${paymentMethod === "card" ? "text-yellow-600 dark:text-yellow-400" : "text-gray-400 dark:text-gray-500"}`}
                    />
                    <input
                      type="radio"
                      name="payment"
                ...
                >
                  <div className="flex items-center justify-between mb-4 dark:text-gray-300">
                    <Truck
                      className={`w-6 h-6 ${paymentMethod === "cod" ? "text-yellow-600 dark:text-yellow-400" : "text-gray-400 dark:text-gray-500"}`}
                    />
                    <input
                      type="radio"
                      name="payment"
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-xs sm:text-sm text-gray-500 font-medium dark:text-gray-400">
                          Quantity: {item.quantity}
                        </span>
                        <span className="w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-500"></span>
                        <span className="text-xs sm:text-sm text-yellow-700 dark:text-yellow-400 font-bold">
          ...
          <div className="lg:col-span-4 mt-8 lg:mt-0 dark:bg-gray-700 dark:border-gray-600">
            <div className="lg:sticky lg:top-32 space-y-6">
              <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-xl shadow-gray-200/50 dark:bg-gray-700 dark:shadow-gray-700/50 dark:border-gray-600">
                ...
                <div className="border-t border-gray-100 dark:border-gray-600 pt-6 mb-8">
                  <div className="flex justify-between items-end">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-[10px] text-gray-400 dark:text-gray-500 uppercase font-bold mt-1">
                        VAT Included
                      </p>
                    </div>
                  </div>
                ...
                <button className="w-full bg-yellow-400 text-gray-900 px-8 py-4 rounded-2xl hover:bg-yellow-500 dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:text-black transition-all duration-300 font-bold text-lg active:scale-95 shadow-xl shadow-yellow-400/20 flex items-center justify-center gap-3">
              ...
              {/* Trust Badge */}
              <div className="bg-gray-100/50 dark:bg-gray-600/50 rounded-2xl p-4 border border-gray-200/50 dark:border-gray-500 flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-gray-400 dark:text-gray-500 flex-shrink-0" />
